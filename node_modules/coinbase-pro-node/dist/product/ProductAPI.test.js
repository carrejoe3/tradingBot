...
describe('ProductAPI', () => {
    ...
    describe('getProducts', () => {
        it('returns list of products', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('watchCandles', () => {
        ...
        it('starts an interval to check for new candles', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const interval = yield global.client.rest.product.watchCandles(productId, granularity);
        ...
        it('emits new candles', (done) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const granularity = _1.CandleGranularity.ONE_HOUR;
            const updateInterval = 60000;
            const firstResponse = [...GET_200_json_2.default];
            const nextCandle = firstResponse.shift();
            ...
            nock_1.default(global.REST_URL)
                ...
                .query(true)
                .reply(() => {
                return [200, JSON.stringify(GET_200_json_2.default)];
            });
            const onNewCandle = jasmine
                .createSpy('onNewCandle')
                .and.callFake((productId, granularity, candle) => {
            ...
            global.client.rest.on(_1.ProductEvent.NEW_CANDLE, onNewCandle);
            yield global.client.rest.product.watchCandles(productId, granularity);
            jasmine.clock().tick(updateInterval);
            jasmine.clock().tick(updateInterval);
        }));
    });
